<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="addres" class="form-label">{{ __('Addres') }}</label>
            <input type="text" name="addres" class="form-control @error('addres') is-invalid @enderror" value="{{ old('addres', $supplier?->addres) }}" id="addres" placeholder="Addres">
            {!! $errors->first('addres', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="type_sup" class="form-label">{{ __('Type Sup') }}</label>
            <input type="text" name="type_sup" class="form-control @error('type_sup') is-invalid @enderror" value="{{ old('type_sup', $supplier?->type_sup) }}" id="type_sup" placeholder="Type Sup">
